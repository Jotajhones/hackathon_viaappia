Com certeza. Integrei as observações técnicas de forma clara e profissional na seção de configuração. Aqui está o conteúdo atualizado para o seu `README.md`:
...
* Docker Engine e Docker Compose (versão 2 ou superior) instalados.
* Portas 5432 (PostgreSQL), 8080 (Backend) e 80 (Nginx/Frontend) disponíveis no *host*.
...
Na raiz do projeto, execute o comando para orquestrar e iniciar os containers:
...
* **Compatibilidade**: Layout testado exclusivamente para resoluções de desktop. Telas com resoluções mariores a  1800px e mobile podem não apresentar bom resultado.